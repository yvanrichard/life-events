...
function makeimg(url) {
	...
	return `<center><img src="${url}" width="250"></center>`;
    } else return '';
};


//// * Read CSV file (from https://code.tutsplus.com/tutorials/parsing-a-csv-file-with-javascript--cms-25626)
//$.ajax({
//  url: 'life-events-yvan.csv',
//  dataType: 'text',
